...
public class GUInitializer extends JFrame implements Initializer {
    ...
    public GUInitializer() {
        ...
        learnModeImg = new LearnModeImg(this);
        testModeImg = new TestModeImg(this);
    ...
    public void changePanel(Panel panel) {
        switch (panel) {
            ...
            case LearnModeImg -> {
                chooseMode.setVisible(false);
                setContentPane(learnModeImg);
                pack();
                learnModeImg.setVisible(true);
                learnModeImg.setRepoImg();
                learnModeImg.setCardImg();
            }
            case TestMode -> {
            ...
            case TestModeImg -> {
                questionsAmount.setVisible(false);
                setContentPane(testModeImg);
                pack();
                testModeImg.setVisible(true);
                testModeImg.setListImg();
                testModeImg.setImgLabel();
                TestMode.currentQuestion = 1;
                testModeImg.updateLabel();
            }
            case FlashCardsMode -> {
                chooseMode.setVisible(false);
